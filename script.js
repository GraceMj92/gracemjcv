...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const products = [
        { id: 'prod-001', name: 'Perruque Bob Courte Lisse', category: 'lisse', size: 10, price: 82500, image: 'wig-lace-front-ondulee.jpg', description: 'Une magnifique perruque coupe bob, idéale pour un look chic et professionnel. Facile à entretenir.', badge: 'popular', colors: [colors[0], colors[1]] },
        ...
        { id: 'prod-005', name: 'Full Lace Extra Longue', category: 'full-lace', size: 32, price: 522500, image: 'wig-lace-front-ondulee.jpg', description: 'Full lace wig permettant de faire toutes sortes de coiffures, y compris des chignons hauts.', badge: 'premium', colors: [colors[0]] },
        { id: 'prod-006', name: 'Cheveux Naturels Ondulés', category: 'naturel', size: 20, price: 220000, image: 'wig-lace-front-ondulee.jpg', description: '100% vrais cheveux humains. Texture ondulée naturelle, très douce au toucher.', badge: null, colors: [colors[0], colors[1], colors[2]] },
        { id: 'prod-007', name: 'Carré Plongeant Lisse', category: 'lisse', size: 12, price: 110000, image: 'wig-lace-front-ondulee.jpg', description: 'Un carré plongeant moderne et élégant. Parfait pour sublimer les traits de votre visage.', badge: 'popular', colors: [colors[0], colors[1]] },
        ...
        { id: 'prod-009', name: 'Maxi Longueur Lisse', category: 'lisse', size: 40, price: 880000, image: 'wig-lace-front-ondulee.jpg', description: "Pour celles qui aiment les longueurs extrêmes. Cheveux d'une qualité exceptionnelle.", badge: 'premium', colors: [colors[0]] },
        { id: 'prod-010', name: 'Boucles Kinky Naturelles', category: 'naturel', size: 16, price: 165000, image: 'wig-lace-front-ondulee.jpg', description: 'Texture afro kinky qui se marie parfaitement avec les cheveux crépus naturels.', badge: null, colors: [colors[0], colors[1]] },
        { id: 'prod-011', name: 'Perruque Grise Tendance', category: 'synthetique', size: 26, price: 357500, image: 'wig-lace-front-ondulee.jpg', description: 'Couleur grise argentée très tendance. Fibres résistantes à la chaleur.', badge: 'promo', colors: [colors[5]] },
        ...
        { id: 'prod-014', name: 'Perruque Pixie Cut', category: 'lisse', size: 10, price: 82500, image: 'wig-lace-front-ondulee.jpg', description: 'Coupe garçonne très féminine. Ne nécessite pratiquement aucun entretien.', badge: 'new', colors: [colors[0], colors[1], colors[5]] },
        { id: 'prod-015', name: 'Cheveux Naturels Lisses XXL', category: 'naturel', size: 36, price: 687500, image: 'wig-lace-front-ondulee.jpg', description: 'Qualité Remy hair exceptionnelle. Lisses, brillants et sans aucun nœud.', badge: 'premium', colors: [colors[0]] },
        { id: 'prod-016', name: 'Ondulée Rousse', category: 'ondule', size: 24, price: 302500, image: 'wig-lace-front-ondulee.jpg', description: 'Une couleur rousse vibrante avec de légères ondulations pour un style unique.', badge: null, colors: [colors[3]] }
    ];
